...
const ProductGrid = ({ category, sort, search }: ProductGridProps) => {
    const { addToCart } = useCart()

    const products = [
        { id: '1', name: 'Garam Masala', price: 299, image: '/images/products/garam-masala.jpg', rating: 4.8, category: 'masalas', weight: '100g' },
        { id: '2', name: 'Red Chilli Powder', price: 249, image: '/images/products/red-chilli.jpg', rating: 4.9, category: 'powders', weight: '100g' },
        { id: '3', name: 'Turmeric Powder', price: 199, image: '/images/products/turmeric.jpg', rating: 4.7, category: 'powders', weight: '200g' },
        { id: '4', name: 'Cumin Powder', price: 179, image: '/images/products/cumin.jpg', rating: 4.8, category: 'powders', weight: '100g' },
        { id: '5', name: 'Premium Turmeric', price: 349, image: '/images/products/turmeric-premium.jpg', rating: 4.9, category: 'powders', weight: '200g' },
    ]
